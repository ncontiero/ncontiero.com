...
[![license mit](https://img.shields.io/badge/licence-MIT-blue)](https://github.com/ncontiero/sbily/blob/master/LICENSE)
...
The Python command will start the Django application at [http://localhost:8000](http://localhost:8000) and Node will start Rspack and a proxy server for automatic reloading at [http://localhost:3000](http://localhost:3000).
...
> **_The steps below will only be necessary if you have not yet carried out the migrations and created a super user! If you have already done so, the application can be accessed at: [http://localhost:3000](http://localhost:3000)_**
...
The Python command will start the Django application at [http://localhost:8000](http://localhost:8000) and Node will start Rspack and a proxy server for automatic loading at [http://localhost:3000](http://localhost:3000).

- Open [http://localhost:3000](http://localhost:3000) to see the application.

## License

This project is under the [MIT license](https://github.com/ncontiero/sbily/blob/master/LICENSE).
