...
Create a `.env` file similar to [`.env.example`](https://github.com/ncontiero/dktube/blob/main/.env.example).
...
This project is licensed under the **MIT** License - see the [LICENSE](https://github.com/ncontiero/dktube/blob/main/LICENSE) file for details.
