...
githubUrl: https://github.com/ncontiero/dktube
...
Crie um arquivo `.env` semelhante a [`.env.example`](https://github.com/ncontiero/dktube/blob/main/.env.example).
...
Este projeto está licenciado sob a Licença **MIT** - consulte o arquivo [LICENSE](https://github.com/ncontiero/dktube/blob/main/LICENSE) para obter detalhes.
